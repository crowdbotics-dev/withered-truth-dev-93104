...
## Project Structure
    ...
    ├── withered_truth_dev_93104  # Django project configurations
...
1. Clone this repo and `cd withered_truth_dev_93104`
...
2. Clone this repo and `cd withered_truth_dev_93104`
