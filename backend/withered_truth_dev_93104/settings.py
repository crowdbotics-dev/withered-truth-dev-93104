"""
Django settings for withered_truth_dev_93104 project.
...
ROOT_URLCONF = 'withered_truth_dev_93104.urls'
...
WSGI_APPLICATION = 'withered_truth_dev_93104.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_truth_dev_93104 API",
    "DESCRIPTION": "API documentation for withered_truth_dev_93104 App",
    "VERSION": "v1",
}
